...
elseif ($action == 'bonussettings'){
	...
	print("<tr><td colspan=2 align=center><b>".$lang_settings['text_things_cost_bonus']."（<span style=\"color:red;\">废弃</span>）</b></td></tr>");
	$dis = "style='width: 50px; background: #eee;' disabled='disabled'";
	tr($lang_settings['row_one_gb_credit'],$lang_settings['text_it_costs_user']."<input type='text' ".$dis." value='".(isset($BONUS["onegbupload"]) ? $BONUS["onegbupload"] : 300 )."'>".$lang_settings['text_one_gb_credit_note'], 1);
	tr($lang_settings['row_five_gb_credit'],$lang_settings['text_it_costs_user']."<input type='text' ".$dis." value='".(isset($BONUS["fivegbupload"]) ? $BONUS["fivegbupload"] : 800 )."'>".$lang_settings['text_five_gb_credit_note'], 1);
	tr($lang_settings['row_ten_gb_credit'],$lang_settings['text_it_costs_user']."<input type='text' ".$dis." value='".(isset($BONUS["tengbupload"]) ? $BONUS["tengbupload"] : 1200 )."'>".$lang_settings['text_ten_gb_credit_note'], 1);
	tr($lang_settings['row_hundred_gb_credit'],$lang_settings['text_it_costs_user']."<input type='text' ".$dis." value='".(isset($BONUS["hundredgbupload"]) ? $BONUS["hundredgbupload"] : 10000 )."'>".$lang_settings['text_hundred_gb_credit_note'], 1);
	tr($lang_settings['row_ten_gb_download_credit'],$lang_settings['text_it_costs_user']."<input type='text' ".$dis." value='".(isset($BONUS["tengbdownload"]) ? $BONUS["tengbdownload"] : 1000 )."'>".$lang_settings['text_ten_gb_download_credit_note'], 1);
	tr($lang_settings['row_hundred_gb_download_credit'],$lang_settings['text_it_costs_user']."<input type='text' ".$dis." value='".(isset($BONUS["hundredgbdownload"]) ? $BONUS["hundredgbdownload"] : 8000 )."'>".$lang_settings['text_hundred_gb_download_credit_note'], 1);

	tr($lang_settings['row_ratio_limit'],$lang_settings['text_user_with_ratio']."<input type='text' ".$dis." value='".(isset($BONUS["ratiolimit"]) ? $BONUS["ratiolimit"] : 6 )."'>".$lang_settings['text_uploaded_amount_above']."<input type='text' ".$dis." value='".(isset($BONUS["dlamountlimit"]) ? $BONUS["dlamountlimit"] : 50 )."'>".$lang_settings['text_ratio_limit_default'], 1);
	tr($lang_settings['row_buy_an_invite'],$lang_settings['text_it_costs_user']."<input type='text' ".$dis." value='".(isset($BONUS["oneinvite"]) ? $BONUS["oneinvite"] : 1000 )."'>".$lang_settings['text_buy_an_invite_note'], 1);
	tr($lang_settings['row_buy_an_tmp_invite'],$lang_settings['text_it_costs_user']."<input type='text' ".$dis." value='".(isset($BONUS["one_tmp_invite"]) ? $BONUS["one_tmp_invite"] : \App\Models\BonusLogs::DEFAULT_BONUS_BUY_TEMPORARY_INVITE )."'>".$lang_settings['text_buy_an_tmp_invite_note'], 1);

	tr($lang_settings['row_custom_title'],$lang_settings['text_it_costs_user']."<input type='text' ".$dis." value='".(isset($BONUS["customtitle"]) ? $BONUS["customtitle"] : 5000 )."'>".$lang_settings['text_custom_title_note'], 1);
	tr($lang_settings['row_vip_status'],$lang_settings['text_it_costs_user']."<input type='text' ".$dis." value='".(isset($BONUS["vipstatus"]) ? $BONUS["vipstatus"] : 8000 )."'>".$lang_settings['text_vip_status_note'], 1);
	tr($lang_settings['row_allow_giving_bonus_gift'], "<span style='color:#999;'>（废弃）当前：".(($BONUS["bonusgift"] ?? 'no') === 'yes' ? $lang_settings['text_yes'] : $lang_settings['text_no'])."</span>", 1);
	tr($lang_settings['row_bonus_gift_tax'], $lang_settings['text_system_charges']."<input type='text' ".$dis." value='".(isset($BONUS["basictax"]) ? $BONUS["basictax"] : 5 )."'>".$lang_settings['text_bonus_points_plus']."<input type='text' ".$dis." value='".(isset($BONUS["taxpercentage"]) ? $BONUS["taxpercentage"] : 10 )."'>".$lang_settings['text_bonus_gift_tax_note'], 1);
    tr($lang_settings['row_cancel_hr'],$lang_settings['text_it_costs_user']."<input type='text' ".$dis." value='".(isset($BONUS["cancel_hr"]) ? $BONUS["cancel_hr"] : \App\Models\BonusLogs::DEFAULT_BONUS_CANCEL_ONE_HIT_AND_RUN )."'>".$lang_settings['text_cancel_hr_note'], 1);
    tr($lang_settings['row_attendance_card'],$lang_settings['text_it_costs_user']."<input type='text' ".$dis." value='".(isset($BONUS["attendance_card"]) ? $BONUS["attendance_card"] : \App\Models\BonusLogs::DEFAULT_BONUS_BUY_ATTENDANCE_CARD )."'>".$lang_settings['text_attendance_card_note'], 1);
    tr($lang_settings['row_buy_rainbow_id'],$lang_settings['text_it_costs_user']."<input type='text' ".$dis." value='".(isset($BONUS["rainbow_id"]) ? $BONUS["rainbow_id"] : \App\Models\BonusLogs::DEFAULT_BONUS_BUY_RAINBOW_ID )."'>".$lang_settings['text_buy_rainbow_id_note'], 1);
    tr($lang_settings['row_buy_change_username_card'],$lang_settings['text_it_costs_user']."<input type='text' ".$dis." value='".(isset($BONUS["change_username_card"]) ? $BONUS["change_username_card"] : \App\Models\BonusLogs::DEFAULT_BONUS_BUY_CHANGE_USERNAME_CARD )."'>".$lang_settings['text_buy_change_username_card_note'], 1);
